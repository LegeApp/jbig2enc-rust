...
impl<'a> Jbig2Encoder<'a> {
    ...
    pub(crate) fn should_skip_symbol_candidate(width: usize, height: usize, black_pixels: usize) -> bool {
    ...
    #[inline]
    pub(crate) fn symbol_unify_assignment_score(result: &crate::jbig2comparator::CompareResult) -> u32 {
        result
            .total_err
