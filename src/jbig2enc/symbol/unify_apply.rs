...
impl<'a> Jbig2Encoder<'a> {
    ...
    pub(crate) fn should_keep_text_local_symbol(&self, page: &PageData, symbol_index: usize) -> bool {
    ...
    pub(crate) fn push_symbol(&mut self, symbol: BitImage, pixel_count: usize, page_num: usize) -> usize {
