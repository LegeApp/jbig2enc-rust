...
fn pdf_split_multi_page_shares_global_dictionary() {
    ...
    assert_eq!(decoded0, page0, "page 0 round-trip against shared globals differs from input");
    assert_eq!(decoded1, page1, "page 1 round-trip against shared globals differs from input");
}
